...
class PersonalScreeen extends StatefulWidget {
  ...
  @override
  State<PersonalScreeen> createState() => _PersonalScreeenState();
}
...
class _PersonalScreeenState extends State<PersonalScreeen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          children: [
            Todo(todoText: ' Taking Bath'),
            Todo(todoText: 'Listen to music'),
            Todo(todoText: 'Reading book'),
            Todo(todoText: 'Go Shopping',)
